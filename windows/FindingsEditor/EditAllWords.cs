...
{
    public partial class EditAllWords : EditFormBase
    {
        protected string sql = "SELECT no, words1, words2, words3, word_order, operator FROM words ORDER BY operator, word_order"; //●●●移植時要変更
        ...
        public EditAllWords()
        {
            ...
            dgv.Columns["operator"].HeaderText = FindingsEditor.Properties.Resources.DiagnosedDr;
            dgv.Columns["word_order"].HeaderText = FindingsEditor.Properties.Resources.Order;
            ...
            this.dgv.Columns["operator"].DisplayIndex = 4;
            btDelColumn.DisplayIndex = 5;
        ...
        private void saveDataTable() //●●●移植時要変更
        {
            ...
            da.InsertCommand.Parameters.Add(new NpgsqlParameter("e", DbType.String));
            ...
            da.InsertCommand.Parameters[4].SourceColumn = "operator";
            ...
            da.UpdateCommand.Parameters.Add(new NpgsqlParameter("ue", DbType.String));
            ...
            da.UpdateCommand.Parameters[5].SourceColumn = "operator";
        ...
        private void EditAllWords_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Validate(); //Without this code, new data will disappear.
            DataTable dt2 = dt.GetChanges();
            if (dt2 != null)

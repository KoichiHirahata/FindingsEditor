...
namespace FindingsEditor
{
    class CLocalDB
    {
        ...
        private static void getWard()
        {
            ...
            { MessageBox.Show("[ward]" + Properties.Resources.NoRecord, "Error", MessageBoxButton.OK, MessageBoxImage.Error); }
            conn.Close();
        }
        ...
        private static void getDepartment()
        {
            ...
            if (localDB.Tables["department"].Rows.Count == 0)
                MessageBox.Show("[department]" + Properties.Resources.NoRecord, "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            conn.Close();
        }
        ...
        private static void getOperators()
        {
            ...
            { MessageBox.Show("[orderDr]" + Properties.Resources.NoRecord, "Error", MessageBoxButton.OK, MessageBoxImage.Error); }
            else
            {
                DataTable operator1;
                DataTable operator2;
        ...
        private static void getAllOp()
        {
            ...
            { MessageBox.Show("[allOp]" + Properties.Resources.NoRecord, "Error", MessageBoxButton.OK, MessageBoxImage.Error); }
            conn.Close();
        }
        ...
        private static void getOpCategory()
        {
            ...
            { MessageBox.Show("[op_category]" + Properties.Resources.NoRecord, "Error", MessageBoxButton.OK, MessageBoxImage.Error); }
            conn.Close();
        }
        #endregion
        ...
        private static void getEquipmentType()
        {
            ...
            { MessageBox.Show("[equipment_type]" + Properties.Resources.NoRecord, "Error", MessageBoxButton.OK, MessageBoxImage.Error); }
            conn.Close();
        }
        ...
        private static void getDiagnoses()
        {
            ...
            { MessageBox.Show("[localDB diag_name]" + Properties.Resources.DataBaseError, "Error", MessageBoxButton.OK, MessageBoxImage.Error); }
            conn.Close();
        }
        ...
        private static void getDiagCategory()
        {
            ...
            { MessageBox.Show("[localDB diag_category]" + Properties.Resources.NoRecord, "Error", MessageBoxButton.OK, MessageBoxImage.Error); }
            conn.Close();
        }
        #endregion
        ...
        private static void getExamStatus()
        {
            ...
            { MessageBox.Show("[exam_status]" + Properties.Resources.NoRecord, "Error", MessageBoxButton.OK, MessageBoxImage.Error); }
            conn.Close();
        }
        ...
        public static void getWords()
        {
            ...
            { MessageBox.Show("[words]" + Properties.Resources.NoRecord, "Error", MessageBoxButton.OK, MessageBoxImage.Error); }
            conn.Close();
        }
